...
FlightSuretyData flightSuretyData;
    ...
    */
    ...
    function isnotAirline(address _address) public view returns (bool) {
        return flightSuretyData.AirlineNotRegistered(_address);
    }
   /**
   ...
   function registerAirline(address _address) external {
     ...
     function fund() public payable requireIsOperational {
        ...
        require(msg.value == 10 ether, "Participant Fee is 10 ether");
  ...
  function registerFlight
    (string flight,address airline,uint timestamp)
...
contract FlightSuretyData {
    ...
    function AirlineNotRegistered(address _address) external view returns (bool);
    ...
    function registerFlight(string flight, address airline, uint timestamp)
        external;
